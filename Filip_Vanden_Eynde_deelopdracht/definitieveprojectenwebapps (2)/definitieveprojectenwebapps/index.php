        ...
        <div class="row">
            ...
            <div class="col-xs-6 col-md-6 col-lg-6">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <form id='login' action='labo3definitief/labo3LoginToDB.php' method='POST' accept-charset='UTF-8'>
                            <input type='hidden' name='submitted' id='submitted' value='1'/>
                            <div class="form-group">
                                <label for="UserName">UserName Admin*:</label>
                                <input type="text" class="form-control" name='user_name' id="user_name"
            ...
            <div class="col-xs-6 col-md-6 col-lg-6">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <form id='login2' action='labo3definitief/labo3LoginToDB.php' method='POST' accept-charset='UTF-8'>
                            <input type='hidden' name='submitted' id='submitted' value='1'/>
                            <div class="form-group">
                                <label for="UserName">UserName user*:</label>
                                <input type="text" class="form-control" name='user_name' id="user_name"
